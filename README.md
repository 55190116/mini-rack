...
| [GeeekPi / DeskPi RackMate TL1](https://amzn.to/4j1Pbuo) | 10U | open design |
...
| [YuanLey YS25-0402P](https://amzn.to/4utEepA) | 1U | Switch Unmanaged, 4x 2.5G RJ45 (PoE, PoE+) / 2x 10G SFP+ |
...
This section is for _systems_, not individual 3D printable parts. For parts like cable modem or mini switch mounts, please see the respective sections elsewhere.
  ...
  - [MandicReally's Mod10 3D 10" mini rack system](https://www.printables.com/model/1225275-modular-10-server-rack-mod10)
  ...
  - [ilanKushnir's KWS Rack](https://makerworld.com/en/collections/17479078-kws-rack-system)
...
There are a variety of commercial options to mount Mini ITX motherboards (or SBC clusterboards, like the Turing Pi 2, or DeskPi Super6C!), or to mount Tiny/Mini/Micro PCs like a Lenovo M series computer.
  ...
  - [DeskPi RackMate 10" 2U Mini ITX shelf](https://frame.work/products/deskpi-rackmate-10-inch-2u-mini-itx-shelf)
...
I'm not the first person to build a mini rack. In fact, the mini-homelab community's been thriving for years! Check out [Reddit r/minilab](https://www.reddit.com/r/minilab/) for some extra inspiration, or click through some of the builds below! Pictured below is an AREDN (Amateur Radio Emergency Data Network) deployable half-rack [built by @cameronzucker](https://github.com/geerlingguy/mini-rack/issues/169)!
...
| kevinmcaleer | 2025 | [Kev's 10" Mini Rack Build](https://github.com/geerlingguy/mini-rack/issues/134) |
